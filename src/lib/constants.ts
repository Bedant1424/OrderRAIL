// Shared layout spacing and height constants (in Tailwind rem/px equivalents)
// Reused across customer mobile UI components to maintain a consistent spacing system.

export const BOTTOM_NAV_HEIGHT = "5.3125rem";  // 85px
