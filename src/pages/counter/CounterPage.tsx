  ...
  return (
    <div className="v8-modal-overlay">
      ...
      >
        ...
        {/* 2. SCROLLABLE CENTER CONTENT BODY WITH 2-COLUMN LANDSCAPE GRID */}
        <div className="v8-dialog-body">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5 items-start">
            {/* LEFT COLUMN (7 Cols): Amount Due Focus, Payment Mode, Tenders, Payment Methods & Inputs */}
            <div className="md:col-span-7 flex flex-col gap-3.5 text-left">
              {/* Amount Due Visual Focus Card */}
              <div className="p-3 bg-primary/5 dark:bg-primary/10 border border-primary/20 rounded-xl text-center flex flex-col items-center justify-center">
              ...
              <div className="flex items-center justify-between p-2.5 rounded-xl bg-muted/30 border border-border/40 text-xs">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    type="button"
                    className={cn('px-3 py-1 rounded-lg font-bold transition cursor-pointer', !isSplitMode ? 'bg-card text-foreground shadow-sm' : 'text-muted-foreground')}
                  ...
                  <button
                    type="button"
                    className={cn('px-3 py-1 rounded-lg font-bold transition flex items-center gap-1 cursor-pointer', isSplitMode ? 'bg-primary text-primary-foreground shadow-sm' : 'text-muted-foreground')}
              ...
              {/* Applied Tenders List (if tenders exist) */}
              {tenders.length > 0 && (
                <div className="flex flex-col gap-1.5 p-3 bg-muted/20 rounded-xl border border-border/30">
                  ...
                  {tenders.map((t) => (
                    <div key={t.id} className="v8-tender-pill">
                      ...
                      {isSplitMode && (
                        <button type="button" className="text-destructive hover:opacity-80 ml-2" onClick={() => handleRemoveTender(t.id)}>
                          <X className="w-3.5 h-3.5" />
                        </button>
                      )}
                    </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {paymentSettings.enabledMethods.cash !== false && (
                  <button
                    type="button"
                    className={cn(
                      'h-12 rounded-xl border font-bold text-xs flex flex-col items-center justify-center gap-1 transition cursor-pointer',
              ...
              {method === 'cash' && (
                <div className="flex flex-col gap-3 p-3.5 bg-muted/20 rounded-xl border border-border/40">
                  ...
                  <div className="grid grid-cols-5 gap-1.5">
                    <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount(currentTenderVal.toFixed(2))}>Exact</button>
                    {!isHighBill ? (
                      <>
                        <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount('100.00')}>₹100</button>
                        <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount('200.00')}>₹200</button>
                        <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount('500.00')}>₹500</button>
                        <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount('1000.00')}>₹1000</button>
                      </>
                    ) : (
                      <>
                        <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount('1500.00')}>₹1500</button>
                        <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount('2000.00')}>₹2000</button>
                        <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount('5000.00')}>₹5000</button>
                        <button type="button" className="py-1.5 bg-card border border-border/40 rounded-lg text-xs font-bold hover:border-primary cursor-pointer" onClick={() => setReceivedAmount((currentTenderVal + 500).toFixed(2))}>+₹500</button>
                      </>
                    )}
                  </div>
              ...
              {method === 'upi' && (
                <div className="p-3.5 bg-muted/20 rounded-xl border border-border/40 flex flex-col gap-3">
                  <div className="flex items-center justify-between">
            ...
            {/* RIGHT COLUMN (5 Cols): Prominent Customer Details & Collapsible Bill Summary */}
            <div className="md:col-span-5 flex flex-col gap-3.5 text-left">
              {/* Customer Details (Optional) - PROMINENTLY AT TOP OF RIGHT COLUMN */}
              <div className="flex flex-col gap-2.5 p-3.5 bg-muted/20 rounded-xl border border-border/40">
