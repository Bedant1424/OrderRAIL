    ...
    <div className="flex flex-col h-full bg-card rounded-3xl p-4 shadow-soft ring-1 ring-border/60 justify-between select-none">
      ...
      <div>
        ...
        <div className="my-3">
          ...
          <div className="max-h-[130px] overflow-y-auto section-scroll pr-1 space-y-1.5 font-mono text-xs">
      ...
      {/* Center Financial Calculations */}
      <div className="py-3 border-y border-border/60 space-y-2 font-mono text-xs">
        ...
        <div className="flex items-center justify-between text-muted-foreground">
          <span className="flex items-center gap-1">
            <Percent className="h-3 w-3 text-amber-500" /> DISCOUNT ({discountPercent}%):
          </span>
        ...
        <div className="pt-2 border-t border-border/60 flex items-center justify-between text-sm font-bold text-foreground">
          ...
          <span className="text-base font-display text-brand font-extrabold">
            ${netTotal.toFixed(2)}
          </span>
        </div>
      </div>

      {/* Bottom Payment Tender & Primary Actions */}
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-1.5 p-1 rounded-2xl bg-secondary/80 text-xs font-semibold">
            <button
              ...
              className={cn(
                "py-1.5 rounded-xl transition flex items-center justify-center gap-1",
                paymentMode === "cash"
        ...
        {paymentMode === "cash" && (
          <div className="grid grid-cols-2 gap-2 text-xs font-mono">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-background py-1.5 pl-7 pr-2 font-bold text-foreground text-xs outline-none focus:ring-2 focus:ring-brand/60"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="rounded-xl bg-muted/60 border border-border py-1.5 px-3 font-bold text-emerald-600 dark:text-emerald-400 text-xs">
                ${changeDue.toFixed(2)}
              </div>
            </div>
          </div>
