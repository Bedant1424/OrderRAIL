...
export function MenuBrowser({ cafeId, currency }: { cafeId: string; currency: string }) {
  ...
  return (
    <div style={{ paddingBottom: bottomPadding }}>
      {/* Customer Large Visual Hero */}
      <div className="px-4 pt-3 pb-1">
        <div className="relative w-full overflow-hidden rounded-2xl border border-cc-border/60 bg-[#1a1210] h-[280px] sm:h-[305px] md:h-[325px] shadow-sm">
          <img
            src={heroImg}
