      ...
      {count > 0 && (
        ...
        >
          <Link
            to={`/t/${tableId}/cart`}
            className={cn(
              "pointer-events-auto mx-auto flex w-full max-w-[420px] items-center justify-between gap-4 rounded-full px-5 py-3.5 bg-brand text-brand-foreground shadow-none"
            )}
          >
            <span className="flex items-center gap-3">
              <span className="grid h-8 w-8 place-items-center rounded-full bg-brand-foreground/15">
