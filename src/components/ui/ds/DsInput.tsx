      ...
      <div className="flex flex-col gap-1 w-full text-left">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            type={type}
            className={cn(
              "w-full rounded-2xl border border-border/40 bg-background py-2.5 px-4 text-xs sm:text-sm font-medium text-foreground outline-none transition-all placeholder:text-muted-foreground/60 focus:border-brand focus:ring-2 focus:ring-brand/30",
